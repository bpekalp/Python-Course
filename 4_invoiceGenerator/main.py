...
dataFolder = "4_invoiceGenerator/datas"
...
for filePath in filePaths:
    ...
    pdf.cell(w=0, h=size, border=0, txt=f"The total due amount is {totalPrice}$", ln=1)
    pdf.image("4_invoiceGenerator/datas/pythonhow.png", w=12)
